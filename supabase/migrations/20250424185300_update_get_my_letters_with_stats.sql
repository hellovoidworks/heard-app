DROP FUNCTION get_my_letters_with_stats(uuid);

-- Update get_my_letters_with_stats function to exclude blocked users from counts
...
BEGIN
  ...
  LOOP
    ...
    -- Count replies for this specific letter, excluding blocked users
    ...
    -- Count reactions for this specific letter, excluding blocked users
