-- Migration to update the get_unread_letters_not_by_user function to use random ordering
-- This makes the letter selection more diverse rather than always showing the newest letters
...
BEGIN
  ...
  -- Using RANDOM() for ordering instead of created_at
